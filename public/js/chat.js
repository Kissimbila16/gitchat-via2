            ...
            <div class="d-flex align-items-center" onclick="singleChat('${contact.user_id}')">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <a class="dropdown-item delete-contact" href="javascript:void(0);" onclick="deleteContact('${contact.id}', '${contact.user_id}')">Remove <i
...
messageForm.addEventListener("submit", (e) => {
  ...
  if (messageId) {
    if (message != '') {
      socket.emit("message_update", { messageId, message, receiverId, userId });
...
socket.on("chat message", function ({ id, message, sender_id, receiver_id, file_upload, createdAt, receiverName, receiverImage, myid }) {
  ...
  if (document.getElementById('s_chat_' + myid) != null) {
    ...
    if (document.getElementById(sender_id) != null) {
      if(parseInt(document.getElementById(sender_id).querySelector('.unread_msg').getAttribute("data-msg")))
      {
...
function outputUsers(users) {
  ...
  if(users != null)
  {
    users.forEach((user) => {
      ...
      var unreadMsgCount = user.unreadMsg = 0 ? getOccurrence(user.unreadMsg, '0') : '';
      ...
      const user_img = user.userImg != undefined ? `<img src="assets/images/users/${user.userImg}" class="rounded-circle avatar-xs" alt="">` : `<div class="avatar-xs"><span class="avatar-title rounded-circle bg-soft-primary text-primary onchangeimg">${user.name[0]}</span></div>`;
...
socket.on('contactInfo', ({ contacts }) => {
  [contacts].forEach(contact => {
    ...
    const user_img = contact.userImg ? `<img src="assets/images/users/${contact.userImg}" class="rounded-circle avatar-xs" alt="">` : `<div class="avatar-xs mx-auto"><span class="avatar-title rounded-circle bg-soft-primary text-primary contact_img">${contact.name[0]}</span></div>`;
    const user_rimg = contact.userImg ? `<img src="assets/images/users/${contact.userImg}" class="rounded-circle avatar-md" alt="">` : `<div class="avatar-md mx-auto"><span class="avatar-title rounded-circle bg-soft-primary text-primary contact_img">${contact.name[0]}</span></div>`;
  ...
  `;
    ...
    const user_img1 = contact.userImg ? `<img src="assets/images/users/${contact.userImg}" class="rounded-circle avatar-lg" alt="">` : `<div class="avatar-lg mx-auto"><span class="avatar-title rounded-circle bg-soft-primary text-primary contact_img">${contact.name[0]}</span></div>`;
    const user_img2 = contact.userImg ? `<img src="assets/images/users/${contact.userImg}" alt="" style="width: 500px; border-radius: 50%;">` : `<div class="mx-auto" style="width:500px; height:500px"><span class="avatar-title rounded-circle bg-soft-primary text-primary contact_img">${contact.name[0]}</span></div>`;
...
let adduchat = (users, receiverName) => {
  ...
  if(users != null)
  {
    users.forEach((user, index) => {
      ...
      var receiver_image = user.image
        ? `<img src="assets/images/users/${user.image}" alt="" class="user-profile-image user-profile-image">`
      ...
      if (imgList.includes(extName)) {
        ...
        var message = `<p class="mb-0 single_message text-break">${user.message}</p>`;
      }
  
      if (user.receiver_id == userId) {
  
        $('.messages__history').prepend(`
            <li class="left msg_${user.id}">
              <div class="conversation-list">
                ...
                <div class="user-chat-content">
                  <div class="ctext-wrap">
                    ...
                    <div class="dropdown align-self-start">
                      ...
                      <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item" href="javascript:void(0);" id="${user.id}" onclick="singleMessageCopy(this)" style="display:${none_editBtn}">Copy <i
                            class="ri-file-copy-line float-end text-muted"></i></a>
                            <a class="dropdown-item" href="javascript:void(0);" onclick="singleForwordMessage(this)" id="${user.id}" type="single" data-bs-toggle="modal" data-bs-target="#forwardContact-Modal">Forward<i class="ri-chat-forward-line float-end text-muted"></i></a>
                      </div>
                    </div>
                  </div>
                  <div class="conversation-name receiver_name">${receiverName}</div>
              ...
              <div class="user-chat-content">
                <div class="ctext-wrap">
                  ...
                  <div class="dropdown align-self-start">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                      <a class="dropdown-item" href="javascript:void(0)" id="${user.id}" onclick="singleMessageCopy(this)" style="display:${none_editBtn}">Copy <i class="ri-file-copy-line float-end text-muted"></i></a>
                      <a class="dropdown-item" href="javascript:void(0);" id="${user.id}" onclick="singleMessageUpdate(this)" style="display:${none_editBtn}">Edit <i class="ri-save-line float-end text-muted"></i></a>
                      <a class="dropdown-item" href="javascript:void(0);" onclick="singleForwordMessage(this)" id="${user.id}" type="single" data-bs-toggle="modal" data-bs-target="#forwardContact-Modal">Forward<i class="ri-chat-forward-line float-end text-muted"></i></a>
                      <a class="dropdown-item" href="javascript:void(0);" id="${user.id}" onclick="singleMessageDelete(this)">Delete <i
                          class="ri-delete-bin-line float-end text-muted"></i></a>
                    </div>
                  </div>
                </div>
      ...
      if (user.file_upload) {
        const receiverMessage = `
        <div class="card p-2 border mb-2 msg_${user.id}">
        <div class="d-flex align-items-center">
          ${image1}
          <div class="flex-grow-1 overflow-hidden">
            <div class="text-start">
          ...
          <div class="ms-4 me-0">
            <ul class="list-inline mb-0 font-size-18">
              ...
              <li class="list-inline-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <a class="dropdown-item" href="javascript:void(0);" id="${user.id}" onclick="singleMessageDelete(this)">Delete</a>
                </div>
              </li>
            </ul>
          </div>
...
function singleMessageDelete(message) {
  ...
  var receiverId = document.querySelector(".user_detail h6").innerHTML;
  socket.emit("message_delete", { message_id, receiverId, userId });
...
socket.on(
  "message_update",
  function ({ messageId, message, receiverId, userId }) {
    if (document.getElementById("s_chat_" + userId) != null) {
      document.querySelector(
        ".msg_" + messageId + " .single_message"
      ).innerHTML = message;
    }
  }
);
  ...
  if(groupMsgs != null)
  {
    if (document.getElementById("g_chat_" + groupMsgs[0].group_id) != null) {
      groupMsgs.forEach(msg => {
        document.querySelector(".group_msg_" + msg.id).remove();
      });
    };
  }
});
...
socket.on("groupLists", ({ groups }) => {
  ...
  if(groups != null)
  {
    groups.forEach((group) => {
      const userBox = `
      <li id="group_list_${group.group_id}">
        <a href="javascript:void(0);" onclick="contact_group('${group.group_id
        }', '${group.name}', '${userId}')">
          <div class="d-flex align-items-center">
...
socket.on("groupInfo", ({ group }) => {
  ...
  const userBox = `
    ...
    <div class="flex-grow-1">
      ...
      <span class="lh-base typing_${group.id}"></span>
      <h6>${group.id}</h6>
    </div>
  `;
  userChat.innerHTML = userBox;
  ...
  document.getElementById('sameid').innerHTML = group.id;
  document.getElementById('vausername-input').value = group.id;
...
socket.on("addGroup", ({ groups }) => {
  const add_group = `
    <li id="group_list_${groups.id}">
      <a href="javascript:void(0);" onclick="contact_group('${groups.id
    ...
    groupUsers.forEach((contact) => {
      if (contact.is_admin == 1 && contact.user_id == userId) {
        ...
        setTimeout(function () {
          ...
          let exit_btn = `<a class="dropdown-item text-danger" onclick="deleteGroup('${contact.group_id}','${contact.user_id}')" href="javascript:void(0);">Delete Group<i class="ri-delete-bin-line float-end text-danger"></i></a>`
...
let addgchat = groups => {
  ...
  if(groups != null)
  {
    groups.forEach((group) => {
      ...
      var receiver_image = group.image ? `<img src="assets/images/users/${group.image}" alt="">` : `<div class="avatar-xs"><span class="avatar-title rounded-circle bg-soft-primary text-primary">${group.name[0][0]}</span></div>`;
      var extName = group.file_upload;
      var attachedList = ["gif", "mp4", "mp3"];
      var imgList = ["jpg", "jpeg", "png"];
      extName = extName.split(".")
      if (imgList.includes(extName[1])) {
          var image = `<ul class="list-inline message-img  mb-0">
                            <li class="list-inline-item message-img-list me-2 ms-0">
                                <div>
              ...
              <div class="user-chat-content">
                <div class="ctext-wrap">
                  ...
                  <div class="dropdown align-self-start">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                      <a class="dropdown-item" href="javascript:void(0)" id="${group.id}" onclick="groupMessageCopy(this)" style="display:${none_editBtn}">Copy <i class="ri-file-copy-line float-end text-muted"></i></a>
                      <a class="dropdown-item" href="javascript:void(0);" id="${group.id}" onclick="singleForwordMessage(this)" type="group" data-bs-toggle="modal" data-bs-target="#forwardContact-Modal">Forward<i class="ri-chat-forward-line float-end text-muted"></i></a>
                    </div>
                  </div>
                </div>
      ...
      const myMsg = `
        <li class="right group_msg_${group.id}">
            <div class="conversation-list">
              <div class="chat-avatar">
                ${receiver_image}
              </div>
              <div class="user-chat-content">
                <div class="ctext-wrap">
                  ...
                  <div class="dropdown align-self-start">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                      <a class="dropdown-item" href="javascript:void(0)" id="${group.id}" onclick="groupMessageCopy(this)" style="display:${none_editBtn}">Copy <i class="ri-file-copy-line float-end text-muted"></i></a>
                          <a class="dropdown-item" href="javascript:void(0);" id="${group.id}" onclick="multiMessageUpdate(this)" style="display:${none_editBtn}">Edit <i class="ri-save-line float-end text-muted"></i></a>
                          <a class="dropdown-item" href="javascript:void(0);" id="${group.id}" onclick="singleForwordMessage(this)" type="group" data-bs-toggle="modal" data-bs-target="#forwardContact-Modal">Forward<i class="ri-chat-forward-line float-end text-muted"></i></a>
                      <a class="dropdown-item" href="javascript:void(0);" id="${group.id}" onclick="groupMsgDelete(this)">Delete <i
                          class="ri-delete-bin-line float-end text-muted"></i></a>
                    </div>
                  </div>
                </div>
      ...
      if (group.file_upload) {
        const receiverMessage = `
          <div class="card p-2 border mb-2 group_msg_${group.id}">
          <div class="d-flex align-items-center">
            ${group_image}
            <div class="flex-grow-1 overflow-hidden">
              <div class="text-start">
            ...
            <div class="ms-4 me-0">
              <ul class="list-inline mb-0 font-size-18">
                ...
                <li class="list-inline-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="javascript:void(0);" id="${group.id}" onclick="groupMsgDelete(this)">Delete</a>
                  </div>
                </li>
              </ul>
            </div>
...
function deleteGroup(id,userId) {
  swal({
    ...
    .then((willDelete) => {
      if (willDelete) {
        socket.emit("group_delete", { id,userId });
      }
    });
};

socket.on("group_delete", function ({ id,userId }) {
